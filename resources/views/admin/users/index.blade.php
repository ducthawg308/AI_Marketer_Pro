                                            ...
                                            @if($item->google_id)
                                                <span class="inline-flex items-center justify-center w-6 h-6 rounded bg-white border border-gray-200" title="Google">
                                                    <svg class="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 488 512">
                                                        ...
                                                        <path fill="#34A853" d="M249 492c67.8 0 124.8-22.4 166.4-60.9l-81.3-63.1c-22.6 15.2-51.5 24-85.1 24-65.3 0-120.7-44.1-140.4-103.5H25.2v64.9C66.5 446.2 151.6 492 249 492z" />
                                                        <path fill="#FBBC05" d="M108.6 288.5c-9.2-27.2-9.2-56.4 0-83.6V140H25.2c-18.5 36.9-29.2 78.4-29.2 123s10.7 86.1 29.2 123l83.4-63.5z" />
                                                        <path fill="#EA4335" d="M249 97.5c35.5 0 67.5 12.2 92.7 36.1l69.6-69.6C373.8 26.4 316.8 4 249 4 151.6 4 66.5 49.8 25.2 140l83.4 64.9C128.3 141.6 183.7 97.5 249 97.5z" />
                                                    </svg>
                                                </span>
                                            @endif
