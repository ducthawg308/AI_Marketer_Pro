...
class UserUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'role' => [
                'required',
                'exists:roles,id', // Validate theo ID của role
            ],
            'roles' => [
                'nullable',
                'array',
            ...
            'roles.*' => [
                'exists:roles,id', // Có thể là ID hoặc name tùy bạn
            ],
            'permissions' => [
                'nullable',
                'array',
            ...
            'facebook_id' => [
                ...
                'string',
                'max:255',
                Rule::unique('users', 'facebook_id')->ignore($userId),
            ],
    ...
    public function messages(): array
    {
        return [
            ...
            'password_confirmation.required_with' => 'Vui lòng nhập :attribute khi thay đổi mật khẩu.',
            
            'role.required' => 'Vui lòng chọn :attribute.',
            'role.exists' => ':attribute không hợp lệ.',
    ...
    protected function prepareForValidation(): void
    {
        ...
        // Chuyển 'role' (ID) thành 'roles' array nếu chưa có 'roles'
