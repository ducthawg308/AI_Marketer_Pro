...
class ScheduleService extends BaseService
{
  ...
  protected function postTextOnly($userPage, $message, $schedule): array
  {
    ...
    $url = "https://graph.facebook.com/{$this->apiVersion}/{$userPage->page_id}/feed";
  ...
  protected function postWithImages($ad, $userPage, $message, $schedule): array
  {
    ...
    foreach ($ad->adImages as $image) {
      ...
      $uploadUrl = "https://graph.facebook.com/{$this->apiVersion}/{$pageId}/photos";
    ...
    $feedUrl = "https://graph.facebook.com/{$this->apiVersion}/{$pageId}/feed";
